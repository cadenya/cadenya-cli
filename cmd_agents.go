		...
		Commands: []*cli.Command{
			...
			},
			{
				...
				Flags: []cli.Flag{
					...
					&cli.StringFlag{Name: "variation-selection-mode", Usage: "Controls how variations are automatically selected when creating objectives Defaults to WEIGHTED when unspecified. One of: random, weighted."},
