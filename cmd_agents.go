		...
		Commands: []*cli.Command{
			...
			},
			{
				...
				Flags: []cli.Flag{
					...
					&cli.StringSliceFlag{Name: "default-variation-assignment", Usage: "Complete set of assigned tools, tool sets, and sub-agents. Order has no meaning. Duplicate (target kind, canonical target ID) pairs are collapsed. On create,…. One YAML/JSON document per occurrence (literal, @path, or -)."},
