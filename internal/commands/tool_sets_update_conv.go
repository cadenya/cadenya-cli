...
// ToolSetsUpdateConversion is the typed request produced from one urfave command.
type ToolSetsUpdateConversion struct {
	Params sdk.ToolSetUpdateParams
	Body   any
}

// ConvertToolSetsUpdate reads urfave values according to Redwood's operation IR.
func ConvertToolSetsUpdate(cmd *cli.Command, out *ToolSetsUpdateConversion) error {
