...
// AIProviderKeysCreateConversion is the typed request produced from one urfave command.
type AIProviderKeysCreateConversion struct {
	Params sdk.AIProviderKeyCreateParams
	Body   any
}

// ConvertAIProviderKeysCreate reads urfave values according to Redwood's operation IR.
func ConvertAIProviderKeysCreate(cmd *cli.Command, out *AIProviderKeysCreateConversion) error {
