...
// AgentPoolsListConversion is the typed request produced from one urfave command.
type AgentPoolsListConversion struct {
	Params sdk.AgentPoolListParams
	Body   any
}

// ConvertAgentPoolsList reads urfave values according to Redwood's operation IR.
func ConvertAgentPoolsList(cmd *cli.Command, out *AgentPoolsListConversion) error {
