...
// AIProviderKeysListConversion is the typed request produced from one urfave command.
type AIProviderKeysListConversion struct {
	Params sdk.AIProviderKeyListParams
	Body   any
}

// ConvertAIProviderKeysList reads urfave values according to Redwood's operation IR.
func ConvertAIProviderKeysList(cmd *cli.Command, out *AIProviderKeysListConversion) error {
