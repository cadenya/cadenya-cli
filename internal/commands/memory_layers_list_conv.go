...
// MemoryLayersListConversion is the typed request produced from one urfave command.
type MemoryLayersListConversion struct {
	Params sdk.MemoryLayerListParams
	Body   any
}

// ConvertMemoryLayersList reads urfave values according to Redwood's operation IR.
func ConvertMemoryLayersList(cmd *cli.Command, out *MemoryLayersListConversion) error {
