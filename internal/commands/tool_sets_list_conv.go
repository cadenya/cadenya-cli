...
// ToolSetsListConversion is the typed request produced from one urfave command.
type ToolSetsListConversion struct {
	Params sdk.ToolSetListParams
	Body   any
}

// ConvertToolSetsList reads urfave values according to Redwood's operation IR.
func ConvertToolSetsList(cmd *cli.Command, out *ToolSetsListConversion) error {
