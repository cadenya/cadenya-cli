...
// ToolSetSecretsListConversion is the typed request produced from one urfave command.
type ToolSetSecretsListConversion struct {
	Params sdk.ToolSetSecretListParams
	Body   any
}

// ConvertToolSetSecretsList reads urfave values according to Redwood's operation IR.
func ConvertToolSetSecretsList(cmd *cli.Command, out *ToolSetSecretsListConversion) error {
