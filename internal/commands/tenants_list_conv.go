...
// TenantsListConversion is the typed request produced from one urfave command.
type TenantsListConversion struct {
	Params sdk.TenantListParams
	Body   any
}

// ConvertTenantsList reads urfave values according to Redwood's operation IR.
func ConvertTenantsList(cmd *cli.Command, out *TenantsListConversion) error {
