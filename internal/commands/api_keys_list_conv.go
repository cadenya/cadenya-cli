...
// APIKeysListConversion is the typed request produced from one urfave command.
type APIKeysListConversion struct {
	Params sdk.APIKeyListParams
	Body   any
}

// ConvertAPIKeysList reads urfave values according to Redwood's operation IR.
func ConvertAPIKeysList(cmd *cli.Command, out *APIKeysListConversion) error {
