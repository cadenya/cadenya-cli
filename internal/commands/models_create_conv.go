...
// ModelsCreateConversion is the typed request produced from one urfave command.
type ModelsCreateConversion struct {
	Params sdk.ModelCreateParams
	Body   any
}

// ConvertModelsCreate reads urfave values according to Redwood's operation IR.
func ConvertModelsCreate(cmd *cli.Command, out *ModelsCreateConversion) error {
