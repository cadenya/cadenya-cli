...
// WorkspaceSecretsListConversion is the typed request produced from one urfave command.
type WorkspaceSecretsListConversion struct {
	Params sdk.WorkspaceSecretListParams
	Body   any
}

// ConvertWorkspaceSecretsList reads urfave values according to Redwood's operation IR.
func ConvertWorkspaceSecretsList(cmd *cli.Command, out *WorkspaceSecretsListConversion) error {
