...
// ToolSetsListEventsConversion is the typed request produced from one urfave command.
type ToolSetsListEventsConversion struct {
	Params sdk.ToolSetListEventsParams
	Body   any
}

// ConvertToolSetsListEvents reads urfave values according to Redwood's operation IR.
func ConvertToolSetsListEvents(cmd *cli.Command, out *ToolSetsListEventsConversion) error {
