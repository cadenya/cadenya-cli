...
// ModelsListConversion is the typed request produced from one urfave command.
type ModelsListConversion struct {
	Params sdk.ModelListParams
	Body   any
}

// ConvertModelsList reads urfave values according to Redwood's operation IR.
func ConvertModelsList(cmd *cli.Command, out *ModelsListConversion) error {
