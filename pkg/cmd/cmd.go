		...
		Commands: []*cli.Command{
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					&agentsVariationsAddAssignment,
					&agentsVariationsAddMemoryLayer,
					&agentsVariationsRemoveAssignment,
					&agentsVariationsRemoveMemoryLayer,
					&agentsVariationsUpdateMemoryLayer,
				},
			},
			{
